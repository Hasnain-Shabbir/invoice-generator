function Logo({ size = '38' }) {
  return (
    <svg
      ...
      viewBox="0 0 38 38"
    >
      <g filter="url(#filter0_dd_84_489)">
        <g clipPath="url(#clip0_84_489)">
          <rect width="32" height="32" x="3" y="2" fill="#fff" rx="8"></rect>
          <rect
            width="32"
            height="32"
            x="3"
            y="2"
            fill="url(#paint0_linear_84_489)"
            rx="8"
          ></rect>
          <path
            fill="#D0D5DD"
          ...
          <path
            ...
            clipRule="evenodd"
          ></path>
          <path fill="#D0D5DD" d="M18.961 2h.078v32h-.078V2z"></path>
          <path fill="#D0D5DD" d="M35 17.96v.079H3v-.078h32z"></path>
          <path
            fill="#D0D5DD"
            d="M29.602 2h.078v32h-.078V2zM13.64 2h.078v32h-.077V2zM24.282 2h.077v32h-.078V2zM8.32 2h.078v32H8.32V2z"
          ></path>
          <path
            fill="#D0D5DD"
            d="M35 28.602v.077H3v-.077h32zM35 12.64v.078H3v-.077h32zM35 23.281v.078H3v-.078h32zM35 7.32v.078H3V7.32h32z"
          ></path>
          <g filter="url(#filter1_dd_84_489)">
            <circle
              cx="19"
              cy="18"
              r="8"
              fill="url(#paint1_linear_84_489)"
            ></circle>
          </g>
          <g filter="url(#filter2_b_84_489)">
            <path
              fill="#fff"
              fillOpacity="0.2"
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_84_489"
          ></feBlend>
          <feColorMatrix
            in="SourceAlpha"
            result="hardAlpha"
          ...
          <feBlend
            in2="effect1_dropShadow_84_489"
            result="effect2_dropShadow_84_489"
          ></feBlend>
          <feBlend
            in="SourceGraphic"
            in2="effect2_dropShadow_84_489"
            result="shape"
          ></feBlend>
        </filter>
        <filter
          id="filter1_dd_84_489"
          width="22"
          height="22"
          x="8"
          y="8"
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_84_489"
          ></feComposite>
          <feBlend
            in="SourceGraphic"
            in2="effect1_backgroundBlur_84_489"
            result="shape"
          ></feBlend>
        </filter>
        <linearGradient
          id="paint0_linear_84_489"
          x1="19"
          x2="19"
          y1="2"
          y2="34"
        ...
        >
          ...
          <stop offset="1" stopColor="#D0D5DD"></stop>
        </linearGradient>
        <linearGradient
          id="paint1_linear_84_489"
          x1="15"
          x2="23"
          y1="26"
          y2="10"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#53389E"></stop>
          <stop offset="1" stopColor="#6941C6"></stop>
        </linearGradient>
